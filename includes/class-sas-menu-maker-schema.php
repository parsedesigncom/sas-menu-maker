<?php
/**
 * Database schema for SAS Menu Maker.
 *
...
class SAS_Menu_Maker_Schema {
	...
	public static function tables() {
		...
		return array(
			'categories'      => $p . 'sas_menu_maker_categories',
			'tags'            => $p . 'sas_menu_maker_tags',
			'allergens'       => $p . 'sas_menu_maker_allergens',
			'items'           => $p . 'sas_menu_maker_items',
			'item_variants'   => $p . 'sas_menu_maker_item_variants',
			'offers'          => $p . 'sas_menu_maker_offers',
			'item_categories' => $p . 'sas_menu_maker_item_categories',
			'item_tags'       => $p . 'sas_menu_maker_item_tags',
			'item_allergens'  => $p . 'sas_menu_maker_item_allergens',
			'offer_items'     => $p . 'sas_menu_maker_offer_items',
			'options'         => $p . 'sas_menu_maker_options',
		);
	}
	...
	/**
	 * Run schema when the persisted db_version is older than SAS_MENU_MAKER_DB_VERSION.
	 *
