...
class SAS_Menu_Maker_Admin {
	 ...
	 * body-class filters to scope work to SAS Menu Maker screens only.
	 *
	 * @var string[]
	 */
	...
	/**
	 * Enqueue admin styles on SAS Menu Maker screens only.
	 *
	 * @param string $hook_suffix Current admin page hook.
	 */
	public function enqueue_styles( $hook_suffix ) {
		if ( ! $this->is_sas_menu_maker_screen( $hook_suffix ) ) {
			return;
		}

		wp_enqueue_style(
			'sas-menu-maker-admin',
			SAS_MENU_MAKER_PLUGIN_URL . 'assets/css/sas-menu-maker-admin.css',
			array(),
			$this->version
		);
	}
	...
	/**
	 * Enqueue admin scripts on SAS Menu Maker screens only.
	 *
	 * @param string $hook_suffix Current admin page hook.
	 */
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script(
			'sas-menu-maker-admin',
			SAS_MENU_MAKER_PLUGIN_URL . 'assets/js/sas-menu-maker-admin.js',
			array(),
			$this->version,
			true
		);
	...
	/**
	 * Append a body class on SAS Menu Maker screens so CSS can scope safely.
	 *
	 ...
	 * WordPress would otherwise auto-generate ("SAS Menu Maker" → "Dashboard").
	...
	/**
	 * Render the SAS Menu Maker dashboard (parent-menu page).
	 */
	public function render_admin_page() {
		...
		require_once SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-display.php';
	}
	...
	public function render_placeholder() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-placeholder.php';
	}
	...
	public function render_categories_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-categories.php';
	}
	...
	public function render_tags_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-tags.php';
	}
	...
	public function render_allergens_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-allergens.php';
	}
	...
	public function render_items_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-items.php';
	}
	...
	public function render_offers_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-offers.php';
	}
	...
	public function render_options_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-options.php';
	}
	...
	public function render_help_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-help.php';
	}
	...
	public function render_about_page() {
		...
		require SAS_MENU_MAKER_PLUGIN_DIR . 'admin/partials/sas-menu-maker-admin-about.php';
	}

	/**
	 * True when the given hook suffix belongs to a SAS Menu Maker screen.
	 *
	 * @param string $hook_suffix Hook suffix passed by admin_enqueue_scripts.
	 * @return bool
	 */
	private function is_sas_menu_maker_screen( $hook_suffix ) {
