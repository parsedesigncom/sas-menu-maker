<?php
/**
 * About SAS Menu Maker admin screen.
 *
...
// This file is `require`d from SAS_Menu_Maker_Admin::render_about_page(), so
	...
	<div class="sas-menu-maker-card">
		<header class="sas-menu-maker-page-header">
			<div class="sas-menu-maker-page-header-row">
				<h1 class="sas-menu-maker-page-title">
					<?php esc_html_e( 'About SAS Menu Maker', 'sas-menu-maker' ); ?>
				</h1>
				<?php if ( '' !== $version ) : ?>
					<span class="sas-menu-maker-about-version">
						<?php
						printf(
		...
		<div class="sas-menu-maker-page-body">
			...
			<section class="sas-menu-maker-about-intro">
				<p>
			...
			<section class="sas-menu-maker-about-features">
				<h2 class="sas-menu-maker-about-section-title"><?php esc_html_e( 'What you get', 'sas-menu-maker' ); ?></h2>
				<?php foreach ( $features as $i => $f ) : ?>
					<?php if ( $i > 0 ) : ?>
						<hr class="sas-menu-maker-about-sep">
					<?php endif; ?>
					<div class="sas-menu-maker-about-feature">
						<span class="sas-menu-maker-about-feature-icon dashicons <?php echo esc_attr( $f['icon'] ); ?>" aria-hidden="true"></span>
						<div class="sas-menu-maker-about-feature-body">
							<h3 class="sas-menu-maker-about-feature-title"><?php echo esc_html( $f['title'] ); ?></h3>
							<p class="sas-menu-maker-about-feature-desc"><?php echo esc_html( $f['desc'] ); ?></p>
						</div>
					</div>
				<?php endforeach; ?>
			</section>

			<section class="sas-menu-maker-about-links">
				<h2 class="sas-menu-maker-about-section-title"><?php esc_html_e( 'Get help & get involved', 'sas-menu-maker' ); ?></h2>
				<ul class="sas-menu-maker-about-link-list">
					<li>
						<span class="dashicons dashicons-book" aria-hidden="true"></span>
						<a href="<?php echo esc_url( $urls['help'] ); ?>"><?php esc_html_e( 'Help & Docs', 'sas-menu-maker' ); ?></a>
						<span class="sas-menu-maker-about-link-desc"><?php esc_html_e( 'Getting started guide plus per-feature walkthroughs.', 'sas-menu-maker' ); ?></span>
					</li>
					<li>
						...
						<span class="sas-menu-maker-about-link-desc"><?php esc_html_e( 'Source code, issue tracker and full developer reference (README.md).', 'sas-menu-maker' ); ?></span>
					</li>
					<li>
						...
						<span class="sas-menu-maker-about-link-desc"><?php esc_html_e( 'Ratings, support forum and downloads.', 'sas-menu-maker' ); ?></span>
					</li>
				</ul>
			</section>

			<section class="sas-menu-maker-about-credits">
				<h2 class="sas-menu-maker-about-section-title"><?php esc_html_e( 'Credits & license', 'sas-menu-maker' ); ?></h2>
				<div class="sas-menu-maker-about-credits-block">
					<a class="sas-menu-maker-about-brand"
						href="https://saeidsamani.de"
						target="_blank"
						rel="noopener"
						aria-label="<?php esc_attr_e( 'Saeid Samani — portfolio', 'sas-menu-maker' ); ?>">
						<img src="<?php echo esc_url( SAS_MENU_MAKER_PLUGIN_URL . 'assets/images/brand.jpg' ); ?>"
							alt="Saeid Samani"
							loading="lazy">
					</a>
					<div class="sas-menu-maker-about-credits-body">
						<p>
							<?php
							printf(
						...
						<p class="sas-menu-maker-about-thanks">
